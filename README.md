...
* **Yang C.**, Condon LE, Maxwell RM, 2023. Unraveling groundwater-stream connections at the continental scale. Submitted to ***Nature X***  
* **Yang C.**, Tijerina-Kreuzer DT, Tran HV, Condon LE, Maxwell RM, 2023. A high-resolution, 3D groundwater-surface water simulation of the contiguous US: Advances in the integrated ParFlow CONUS 2.0 modeling platform. ***Journal of Hydrology***, revised. Preprint on EarthArXiv, https://doi.org/10.31223/X5D96H  
* Tran HV*, **Yang C***, Condon LE, Maxwell RM, 2023. The Budyko shape parameter as a descriptive index for streamflow loss. ***Frontiers in Water***, in press.  
...
* Tijerina-Kreuzer DT, Swilley JS, Tran HV, Zhang J, West B, **Yang C.**, Condon LE, Maxwell RM, 2023. Continental scale hydrostratigraphy: basin-scale testing of alternative data-driven approaches. ***Groundwater***, revised
* Swilley JS, Tijerina-Kreuzer DT, Tran HV, Zhang J, **Yang C.**, Condon LE, Maxwell RM, 2023. Continental scale hydrostratigraphy: comparing datasets to analytical solutions. ***Groundwater***, in press
## Presentations
